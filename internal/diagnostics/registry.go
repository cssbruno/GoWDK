...
var Registry = []Code{
	...
	{Code: "aria_hidden_focusable", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "focusable element is hidden from assistive technology"},
	{Code: "aria_role_attribute_mismatch", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "ARIA attribute is not valid for the element role"},
	...
	{Code: "audit_cors_credentialed_wildcard", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "CORS allows any origin together with credentials, which exposes credentialed responses to every site"},
	{Code: "audit_cors_wildcard_origin", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "CORS allows any origin, so generated API and contract endpoints accept cross-origin requests from any site"},
	{Code: "audit_guard_unverified", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "a guard is app-owned and has no runtime fixture evidence"},
	...
	{Code: "audit_header_csp_weak", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "Content-Security-Policy is configured with a weak value (wildcard source or unsafe-inline/unsafe-eval) that does not meaningfully constrain script execution"},
	{Code: "audit_header_frame_conflict", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "framing policy is inconsistent: X-Frame-Options and the CSP frame-ancestors directive disagree, or X-Frame-Options carries an unrecognized value"},
	{Code: "audit_header_hsts_weak", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "Strict-Transport-Security is configured but its max-age is missing, zero, or too short to be effective for the build mode"},
	{Code: "audit_header_nosniff_missing", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "security headers are configured but X-Content-Type-Options: nosniff is missing, so MIME sniffing is not disabled"},
	{Code: "audit_header_referrer_weak", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "Referrer-Policy is configured with a value that can leak full URLs across origins"},
	...
	{Code: "audit_observability_absolute_source", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "observability span data can export absolute source paths"},
	{Code: "audit_observability_batch_limit_missing", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "observability browser ingestion does not declare a batch limit"},
	{Code: "audit_observability_body_limit_missing", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "observability browser ingestion does not declare a body limit"},
	{Code: "audit_observability_content_type_missing", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "observability browser ingestion does not require a JSON content type"},
	{Code: "audit_observability_origin_unchecked", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "observability endpoints do not declare a loopback or origin access policy"},
	{Code: "audit_observability_production_exposed", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "observability endpoints are mounted outside the debug-only lane"},
	...
	{Code: "audit_raw_html_exception_expired", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "a raw-HTML policy exception has passed its expiry date and no longer suppresses its sink"},
	{Code: "audit_raw_html_exception_malformed", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "a raw-HTML policy exception is missing a required field (owner, justification, expiry, or sanitizer) or has an invalid expiry"},
	{Code: "audit_raw_html_exception_unmatched", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "a raw-HTML policy exception fingerprint matches no current sink, so the sink moved or the exception is stale"},
	{Code: "audit_raw_html_sink", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "view renders raw HTML through g:unsafe-html without a policy allowlist entry"},
	{Code: "audit_request_limit_missing", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "endpoint does not declare a positive raw request body limit, so an unbounded request body can be read"},
	{Code: "audit_request_limit_phase_unsafe", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "endpoint request body limit is not installed before the body is parsed, so CSRF parsing or handler execution can read past the limit"},
	{Code: "audit_request_limit_unbounded_multipart", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "endpoint accepts multipart/upload bodies without a multipart byte limit"},
	...
	{Code: "audit_test_stale", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "a checked-in generated audit test no longer matches the current posture schema, compiler, policy, or posture"},
	...
	{Code: "audit_waiver_digest_mismatch", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "a waiver pins a policy or posture digest that no longer matches the current build, so it no longer suppresses its finding"},
	{Code: "audit_waiver_expired", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "a waiver has passed its expiry date and no longer suppresses its finding"},
	{Code: "audit_waiver_malformed", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "a waiver is missing a required field (code, target, owner, justification, or expiry) or has an invalid expiry"},
	{Code: "audit_waiver_unmatched", Area: "audit", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "a waiver matches no current finding, so the finding it suppressed is gone or the waiver is stale"},
	...
	{Code: "compile_time_block_parse_error", Area: "config", Stability: StabilityStable, Severity: SeverityError, Summary: "compile-time config block could not be parsed"},
	...
	{Code: "component_composition_cycle", Area: "components", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "component composition graph contains a cycle"},
	...
	{Code: "contract_invalidation_invalid", Area: "contracts", Stability: StabilityExperimental, Severity: SeverityError, Summary: "contract invalidation edge does not match scanned command, event, and query registrations"},
	...
	{Code: "decode_request", Area: "config", Stability: StabilityStable, Severity: SeverityError, Summary: "executable config helper could not decode a bridge request"},
	{Code: "directive_lane_invalid", Area: "parser", Stability: StabilityStable, Severity: SeverityError, Summary: "g:lane is malformed or appears without a structural directive"},
	{Code: "directive_lane_mismatch", Area: "compiler", Stability: StabilityStable, Severity: SeverityError, Summary: "declared directive lane disagrees with its data source"},
	{Code: "directive_lane_required", Area: "parser", Stability: StabilityStable, Severity: SeverityError, Summary: "g:for or g:if is missing an explicit server/client lane"},
	...
	{Code: "duplicate_literal_id", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "literal HTML id is declared more than once in one view"},
	...
	{Code: "duplicate_structured_data", Area: "seo", Stability: StabilityExperimental, Severity: SeverityError, Summary: "page declares the same structured-data kind more than once"},
	{Code: "empty_link_text", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "link with href has no accessible text"},
	{Code: "env_file_line_too_long", Area: "config", Stability: StabilityStable, Severity: SeverityError, Summary: "environment file line exceeds the documented input limit"},
	...
	{Code: "ghtml_over_load_data", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "g:unsafe-html renders request-time server {} data as raw HTML, bypassing escape-by-default"},
	...
	{Code: "go_server_requires_request_render", Area: "go-block", Stability: StabilityExperimental, Severity: SeverityError, Summary: "go server block requires request-time page rendering"},
	{Code: "go_ssr_renamed_to_server", Area: "go-block", Stability: StabilityExperimental, Severity: SeverityError, Summary: "go ssr {} was renamed to go server {}"},
	...
	{Code: "heading_order_skip", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "heading level skips over the next sequential heading"},
	{Code: "interactive_semantics_missing", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "custom interactive element is missing role, focus, or keyboard semantics"},
	{Code: "invalid_aria_attribute", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "ARIA attribute name is not in the supported static accessibility set"},
	{Code: "invalid_aria_role", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "ARIA role is not in the supported static accessibility set"},
	...
	{Code: "invalid_structured_data", Area: "seo", Stability: StabilityExperimental, Severity: SeverityError, Summary: "page structured-data metadata uses an unsupported kind"},
	{Code: "invalid_tabindex", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "tabindex value is not a valid integer"},
	...
	{Code: "malformed_go_import", Area: "packages", Stability: StabilityStable, Severity: SeverityError, Summary: "GOWDK source Go import declaration is malformed"},
	...
	{Code: "malformed_package_declaration", Area: "packages", Stability: StabilityStable, Severity: SeverityError, Summary: "GOWDK package declaration is malformed"},
	...
	{Code: "missing_accessible_name", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "interactive control has no accessible name"},
	{Code: "missing_auth_registration", Area: "interop", Stability: StabilityStable, Severity: SeverityError, Summary: "native RBAC guards have no explicit typed provider"},
	{Code: "missing_button_type", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "button element is missing an explicit type"},
	{Code: "missing_form_label", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "form control is missing an accessible label"},
	{Code: "missing_guard_registration", Area: "interop", Stability: StabilityStable, Severity: SeverityError, Summary: "custom route guards have no explicit typed provider"},
	...
	{Code: "missing_landmark_name", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "explicit landmark has no accessible name"},
	{Code: "missing_load_registration", Area: "interop", Stability: StabilityStable, Severity: SeverityError, Summary: "request-time page load is not explicitly registered"},
	...
	{Code: "policy_baseline_override", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "a declared audit policy reuses a built-in baseline policy name; baseline policies cannot be replaced, only extended or waived"},
	...
	{Code: "policy_rule_code_incompatible", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "an audit rule pins a diagnostic code that is not compatible with the rule family"},
	{Code: "policy_rule_code_severity_lowered", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "an audit rule pins a diagnostic code whose severity is below the rule's minimum severity"},
	{Code: "policy_rule_code_unknown", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "an audit rule pins a diagnostic code that is not registered"},
	...
	{Code: "positive_tabindex", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "positive tabindex changes natural focus order"},
	{Code: "protocol_mismatch", Area: "config", Stability: StabilityStable, Severity: SeverityError, Summary: "executable config helper protocol versions do not match"},
	...
	{Code: "query_invalidation_invalid", Area: "realtime", Stability: StabilityExperimental, Severity: SeverityError, Summary: "query invalidation targets invalid contract metadata"},
	{Code: "query_invalidation_missing", Area: "realtime", Stability: StabilityExperimental, Severity: SeverityError, Summary: "query invalidation has no matching contract metadata"},
	...
	{Code: "server_for_invalid", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "server-lane g:for has invalid \"item in Items\" syntax"},
	{Code: "server_for_nested_scope", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "nested server-lane g:for collection does not reference the enclosing row item"},
	...
	{Code: "source_line_too_long", Area: "parser", Stability: StabilityStable, Severity: SeverityError, Summary: "GOWDK source line exceeds the documented input limit"},
	...
	{Code: "ssr_command_no_client", Area: "rendering", Stability: StabilityExperimental, Severity: SeverityWarning, Summary: "request-time page declares a g:command write form with no g:query region to refresh, so the write is non-reactive and has no no-JavaScript fallback"},
	...
	{Code: "unknown_method", Area: "config", Stability: StabilityStable, Severity: SeverityError, Summary: "executable config helper received an unsupported bridge method"},
	{Code: "unresolved_accessibility_reference", Area: "accessibility", Stability: StabilityStable, Severity: SeverityWarning, Summary: "literal ARIA or label reference does not resolve to a literal id"},
