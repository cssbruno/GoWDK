...
var Registry = []Code{
	...
	{Code: "geach_invalid", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "g:each directive has invalid \"item in Items\" syntax"},
	{Code: "geach_nested_scope", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "nested g:each collection does not reference the enclosing row item"},
	...
	{Code: "ghtml_over_load_data", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "g:unsafe-html renders request-time load {} data as raw HTML, bypassing escape-by-default"},
	{Code: "gif_over_load_data", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "g:if branches on request-time load {} data instead of client state; use g:when"},
	...
	{Code: "gwhen_nested_scope", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "nested g:when condition does not reference the enclosing row item"},
	{Code: "gwhen_requires_load", Area: "pages", Stability: StabilityStable, Severity: SeverityError, Summary: "g:when condition is not an SSR load {} field"},
