...
| 3 | Source import semantics | Cross-package components, layouts, stores, and assets have explicit `use` semantics. Component-scoped imports and qualified layout references are either implemented or rejected with clear diagnostics. |
