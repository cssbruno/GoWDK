...
var Registry = []Code{
	...
	{Code: "audit_client_route_unguarded", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "a client or SPA route is not covered by the generated default-deny registry"},
	{Code: "audit_guardless_endpoint_page", Area: "audit", Stability: StabilityExperimental, Severity: SeverityError, Summary: "a page exposing act, api, or fragment endpoints declares no guard"},
