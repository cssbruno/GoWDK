...
- Security audit (`gowdk audit`): `audit_action_missing_csrf`,
  ...
  `audit_cors_credentialed_wildcard`, `audit_cors_wildcard_origin`,
  `audit_guard_unverified`, `audit_guardless_endpoint_page`, `audit_bundle_secret`,
  `audit_client_route_unguarded`,
  `audit_header_csp_weak`, `audit_header_frame_conflict`,
  `audit_header_hsts_weak`, `audit_header_nosniff_missing`,
  ...
  `audit_raw_html_sink`, `audit_raw_html_exception_expired`,
  `audit_raw_html_exception_malformed`, `audit_raw_html_exception_unmatched`,
  `audit_max_body_exceeds_policy`, `audit_request_limit_missing`,
  `audit_request_limit_phase_unsafe`, `audit_request_limit_unbounded_multipart`,
  `audit_public_not_allowed`, `audit_required_guard_missing`,
  `audit_runtime_mismatch`, `audit_test_failed`, `audit_test_stale`,
  `audit_test_timeout`, `audit_waiver_digest_mismatch`, `audit_waiver_expired`,
  `audit_waiver_malformed`, `audit_waiver_unmatched`,
  `policy_baseline_override`, `policy_duplicate_name`,
  `policy_extends_cycle`, `policy_rule_code_incompatible`,
  `policy_rule_code_severity_lowered`, `policy_rule_code_unknown`,
