...
| `internal/lsp` | Language Server Protocol bridge for diagnostics, formatting, and completions. | Tools | Dependency-free stdio server implemented with baseline and open-project completions. |
