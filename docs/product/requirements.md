...
- Should build targets eventually support per-target addon and render-mode
  overrides?
- What exact `.gwdk` syntax should bind pages/forms to typed command and query
