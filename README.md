...
- `docs/product/action-file-input-safety-spec.md`: current generated action upload safety slice.
- `docs/product/action-file-input-safety-plan.md`: implementation plan for upload safety checks.
