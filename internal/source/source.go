...
const (
	...
	BackendSignatureAPI0            BackendSignatureKind = "api0"
	BackendSignatureAPIInput        BackendSignatureKind = "api_input"
	BackendSignatureAPIInputPtr     BackendSignatureKind = "api_input_ptr"
