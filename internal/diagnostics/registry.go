...
var Registry = []Code{
	...
	{Code: "missing_page_guard", Area: "guards", Stability: StabilityExperimental, Summary: "page does not declare whether it is public or protected"},
	...
	{Code: "public_guard_exclusive", Area: "guards", Stability: StabilityExperimental, Summary: "public guard cannot be combined with protected guard IDs"},
