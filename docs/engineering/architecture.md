...
| `internal/gwdkir` | Stable internal compiler IR shared by generated-output passes. | Compiler | IR records for packages, source files, page routes, backend endpoints, templates, client behavior, and asset scope/hash metadata implemented. Generated artifact planning stays in the consuming generator packages. |
