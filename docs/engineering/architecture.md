...
dynamic route matching, param replacement, declared `load {}` identifier or
dotted-path replacement through same-package Go load functions, and first-slice
partial action fragment responses. Generated apps can discover same-package
