...
- `docs/product/action-body-limit-spec.md`: current generated action request body limit slice.
- `docs/product/action-body-limit-plan.md`: implementation plan for action body limits.
